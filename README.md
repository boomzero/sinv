...
The hunter also gains pursuit speed as gems upgrade your engine, including the extra thrust from big gems. This upgrade pressure continues beyond its time/orb speed cap and is not scaled by difficulty, so the hunter only slowly gains on endgame cruising on Normal and above instead of pulling away. Boost still opens a gap; terrain and gravity maneuvers remain ways to break pursuit.
