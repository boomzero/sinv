...
The hunter also gains pursuit speed as gems upgrade your engine, including the extra thrust from big gems. This upgrade pressure is 75% of your own cruise gain, continues beyond its time/orb speed cap and is not scaled by difficulty, so gems help you pull away (fast flight through the field is already risky). Time escalation still catches a dragged-out run with the minimum escape loadout on Normal and above. Boost still opens a gap; terrain and gravity maneuvers remain ways to break pursuit.
...
Five pink **magnetism capsules** grant 12 seconds of attraction within 480 world units. Big triple-value gems are attracted within 240 units, shown by the inner pink ring. Pickups build momentum under a strong baseline pull across the entire field, with extra attraction as they approach, curving toward you when you turn. With a clear path, a resting pickup at the outer edge reaches a stationary ship in under four seconds. Gentle momentum damping lets brief orbits settle inward when you stop. Ordinary gems, antimatter, repair orbs, shields, boost fuel and other magnets retain the full range; the magnetic force penetrates walls, but pickups collide with solid terrain and slide along its surface. Changing your approach can guide them around wall ends; a straight pull into a wall still stops them. Leaving the field or letting it expire stops their motion. Another capsule refreshes the duration. The pink field and HUD countdown show when the skill is active, and pausing freezes its timer. The field rings disappear when you die.
