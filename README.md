...
Five pink **magnetism capsules** grant 12 seconds of attraction within 240 world units. Big triple-value gems require a closer pass within 80 units, shown by the inner pink ring: magnetism helps collect them while you fly the dangerous route, but cannot extract them from outside the Binary's gravity field. Pickups start moving gently and build momentum under a pull that strengthens as they approach, curving toward you when you turn. Ordinary gems, antimatter, repair orbs, shields, boost fuel and other magnets retain the full range; solid terrain blocks attraction. Leaving the field or letting it expire stops their motion. Another capsule refreshes the duration. The pink field and HUD countdown show when the skill is active, and pausing freezes its timer.
